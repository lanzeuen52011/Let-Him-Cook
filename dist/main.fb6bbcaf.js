...
var imgsEl = document.querySelectorAll(".image_slider");
...
function updateImg() {
  if (window.screen.availWidth >= 1024) {
    ...
    imageContainerEl.style.transform = "translateX(-".concat((currentImg - 1) * 1024, "px)");
    ...
    imageContainerEl.style.transform = "translateX(-".concat((currentImg - 1) * 768, "px)");
    timeout = setTimeout(function () {
      currentImg++;
      updateImg();
    }, 3000);
    ...
    imageContainerEl.style.transform = "translateX(-".concat((currentImg - 1) * 300, "px)");
    timeout = setTimeout(function () {
      currentImg++;
      updateImg();
    }, 3000);
